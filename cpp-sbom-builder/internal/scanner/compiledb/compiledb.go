// Package compiledb detects third-party dependencies from compile_commands.json, a compilation
// database generated by CMake and other build systems. It extracts -l (linked library) and
// -I (include path) flags from each compile command; libraries and include paths that fall
// outside the project root are treated as third-party dependencies.
package compiledb
